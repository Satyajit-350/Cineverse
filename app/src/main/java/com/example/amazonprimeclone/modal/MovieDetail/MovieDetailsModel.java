...
public class MovieDetailsModel {
    ...
    private int runtime;
    private List<SpokenLang> spoken_languages;
    ...
    public MovieDetailsModel(boolean adult, String backdrop_path, BelongToCollection belongs_to_collection, long budget, List<Genres> genres, String homepage, int id, String imdb_id, String original_language, String original_title, String overview, double popularity, String poster_path, List<ProductionCompany> production_companies, List<ProductionCountry> production_countries, String release_date, long revenue, int runtime, List<SpokenLang> spoken_languages, String status, String tagline, String title, boolean video, float vote_average, int vote_count) {
        this.adult = adult;
    ...
    public List<SpokenLang> getSpoken_languages() {
        return spoken_languages;
    }

    public void setSpoken_languages(List<SpokenLang> spoken_languages) {
        this.spoken_languages = spoken_languages;
    }
