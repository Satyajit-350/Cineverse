...
public class MovieResponseResults {
    ...
    public MovieResponseResults(Long vote_count, int id,
                                boolean videos, float vote_average, String title,
                                String poster_path, String original_language, String original_title,
                                List<Integer> genre_ids, String overview, String backdrop_path,
